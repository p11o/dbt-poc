-- SCHEMA GENERATED FROM HIVE
--
-- To reproduce this schema, run the following where hive is installed
...
1	hive	Default catalog for Hive	file:/user/hive/warehouse
\.
...
1	1651676442	1	admin	ROLE	admin	ROLE	All	SQL
\.
...
1	1651676442	admin	admin
2	1651676442	public	public
\.
